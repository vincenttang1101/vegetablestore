...
<head>
  ...
  <title> <?php echo $_SESSION['Role'] ?> | Goods Receipt Details</title>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo $server_root ?>/admin/pages/management/goodsreceipt/list/index.php" class="nav-link active">
