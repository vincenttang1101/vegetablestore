...
$(document).ready(function() {
  $('#types_statistics').on('change', function (e) {
    ...
    if ($('#types_statistics option:selected').val() == "List") {
      window.location.assign("http://localhost/vegetablestore/admin/pages/management/statistic/condition/sales/index.php");
    } 
  });
  ...
  var char = new Morris.Bar({
    element: 'chart',
    xkey: 'OrderDate',
    ykeys: ['SumOrder','Quantity','Revenue'],
    labels: ['Total order','Quantity of vegetables sold','Sales']
  });
