...
<div class ="container-fluid">
  <div class="form-inline mb-3 pt-4">
      <h3><span class="text-primary" style="font-weight: bold">Best Selling Statistics</span></h3>
  </div>
...
$(document).ready(function() {
  $('#types_statistics').on('change', function (e) {
    ...
    if ($('#types_statistics option:selected').val() == "Chart") {
      window.location.assign("http://localhost/vegetablestore/admin/pages/management/statistic/condition/best-selling/operation/convert/index.php");
    } 
  });
