<?php 
    ...
    if (isset($_POST['OrderID'])) {
        ...
        $DataOrder = array ($OrderID, $ShipDate, $Payment, $Note, $Status, $ShipPlace);
        $output_orderlist = '';
        $result_order = $classOrder->updateOrder($DataOrder);
        if ($result_order) {
            ...
            $output_orderlist .= "<div class='alert alert-danger' id='alert-danger'>The Order has been unsuccessfully updated</div>";
        }
