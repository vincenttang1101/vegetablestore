...
<head>
  ...
  <title> <?php echo $_SESSION['Role'] ?> | Order List</title>
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <div class="input-group input-group-sm">
            <input class="form-control form-control-navbar" id="search_category_name" type="text" placeholder="Search" aria-label="Search">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo $server_root ?>/admin/pages/management/order/list/index.php" class="nav-link active">
