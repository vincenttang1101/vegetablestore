...
if (!empty($_POST)) {
    ...
    $Status = $_POST['Status'];
    $output_stafflist = '';
    $DataStaff = array($StaffID, $Username, $Password, $StaffName, $Email, $Phone, $Address, $Role, $Status);
    $result_updatestaff = $classStaff->updateStaff($DataStaff);
    if ($result_updatestaff) {
        $message = "The Staff has been successfully updated";
        ...
        $output_stafflist .= "<div class='alert alert-danger' id='alert-danger'>The Staff has been unsuccessfully updated</div>";
    }
