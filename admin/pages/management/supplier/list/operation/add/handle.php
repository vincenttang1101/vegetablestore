<?php
    ...
    if (!empty($_POST)) {
        ...
        $output_supplierlist = '';
        $DataSupplier = array ($SupplierName, $Email, $Phone, $Address);
        $result_addsupplier = $classSupplier->addSupplier($DataSupplier);
        if ($result_addsupplier) {
            ...
            $output_supplierlist .= "<div class='alert alert-danger' id='alert-danger'>The Supplier has been unsuccessfully added</div>";
        }
