<?php
    ...
    if (isset($_POST['keywords'])) {
        ...
        $result_searchCategoryName = $classCategory->searchByName($keywords);
        if (is_array($result_searchCategoryName) || is_object($result_searchCategoryName)) {
            ...
            foreach ($result_searchCategoryName as $Category) {
        ...
        } else $output_CategoryList .= "<div class='alert alert-danger' id='alert-danger'>No result found</div>";
