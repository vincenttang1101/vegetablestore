...
<head>
  ...
  <title> <?php echo $_SESSION['Role'] ?> | Category Details</title>
        ...
        <div class="navbar-search-block">
          <form class="form-inline" method="GET">
            <div class="input-group input-group-sm">
              <input class="form-control" name="id" type="search" placeholder="Search by Vegetable ID" aria-label="Search">&emsp;
              <input class="form-control" name="name" type="search" placeholder="Search by Vegetable Name" aria-label="Search">&emsp;
              ...
              ?>
                <option><?php echo $category['Name']; endforeach ?>
              </select>
              &emsp;
              <select name="status">
                <option>Status</option>
                <option>Trading commerce</option>
                <option>Trading halt</option>
              </select> 
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item menu-open">
              <a id="click_category" href="<?php echo $server_root ?>/admin/pages/management/category/list/index.php" class="nav-link active">
