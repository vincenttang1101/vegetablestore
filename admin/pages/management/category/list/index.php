...
<head>
  ...
  <title> <?php echo $_SESSION['Role'] ?> | Category List</title>
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <div class="input-group input-group-sm">
            <input class="form-control form-control-navbar" id="search_category_name" type="text" placeholder="Search by Category Name" aria-label="Search">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <?php if ($_SESSION['Role'] == "Admin" || $_SESSION['Role'] == "Manager")  { ?>
          <li class="nav-item">
            <a href="<?php echo $server_root ?>/admin/pages/management/customer/list/index.php" class="nav-link">
